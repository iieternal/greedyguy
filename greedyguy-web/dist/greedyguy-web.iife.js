    ...
    try {
      ...
      if (!factory) {
        ...
        if (!glueUrl) {
          if (_isNode) {
            ...
            glueUrl = join(dirname(fileURLToPath((document.currentScript && document.currentScript.src || ""))), '..', 'dist', 'greedyguy-glue.js');
            ...
            if (!glueUrl && typeof import.meta !== 'undefined' && (document.currentScript && document.currentScript.src || "")) {
              glueUrl = new URL('../dist/greedyguy-glue.js', (document.currentScript && document.currentScript.src || "")).href;
            }
          }
      ...
      if (opts.wasmBinary) {
        ...
        if (!wasmPath) {
          const { join, dirname } = await import('node:path');
          const { fileURLToPath } = await import('node:url');
          wasmPath = join(dirname(fileURLToPath((document.currentScript && document.currentScript.src || ""))), '..', 'dist', 'greedyguy.wasm');
        }
        ...
        if (!wasmUrl) {
          if (typeof import.meta !== 'undefined' && (document.currentScript && document.currentScript.src || "")) {
            wasmUrl = new URL('../dist/greedyguy.wasm', (document.currentScript && document.currentScript.src || "")).href;
          } else {
 ...
 * @returns {string}
 */
function decompressBase64Text(b64) {
 ...
 */
async function fetchAndDecompress(url, fetchOpts, ggOpts = {}) {
  ensureReady();
